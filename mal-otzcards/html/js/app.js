    ...
    methods: {
        ...
        EVENT_KEYPRESS(event) {
            if (this.isShow) {
                ...
                if (event.which == 8) {
                    $('#container-cards').fadeOut(0);
                    $.post('https://mal-outlawzcards/escape', JSON.stringify({}));
                    this.displayClose = false;
                    this.displayOpenInventory = false;
                    this.displayOpenAnother = false;
                }
        ...
        openAnother: function (event) {
            $('#container-kartu').fadeOut(0);
            $.post('https://mal-outlawzcards/openAnother', JSON.stringify({ remain: this.remain }));
            this.displayClose = false;
            this.displayOpenInventory = false;
            this.displayOpenAnother = false;
        },
        openInventory: function (event) {
            $('#container-kartu').fadeOut(0);
            $.post('https:/mal-outlawzcards/openInventory', JSON.stringify({}));
            this.displayClose = false;
            this.displayOpenInventory = false;
            this.displayOpenAnother = false;
        },
